...
precision & $\frac{TP}{TP + FP}$ & $\sfrac{3}{4}$ & $1$\\
recall & $\frac{TP}{TP + FN}$ & $\sfrac{3}{4}$ & $\sfrac{2}{6}$\\
true positive rate & $\frac{TP}{TP + FN}$  & $\sfrac{3}{4}$ & $\sfrac{4}{6}$ \\
false positive rate & $\frac{FP}{TN + FP}$  & $\sfrac{1}{4}$ & $0$\\
\end{tabular}
\egroup
\end{center}
...
we get 
\[
y_1 = \ma{1 & 3.2}, \;\; y_2 = \ma{1.1 & 2.8} \;\; y_3 = \ma{1.9 & 0.6}
\]
}{}
...
This is the singular value decomposition of $\A$. This gives us

\begin{align*}
\A = \U\Z\U^T &= \sqrt{\sfrac{1}{2}}\begin{pmatrix}1 & -1\\1 & 1\end{pmatrix}\begin{pmatrix} 5 & 0 \\ 0 & 2\end{pmatrix}\sqrt{\sfrac{1}{2}}\begin{pmatrix}1 & 1\\-1 & 1\end{pmatrix}\\
